...
const mockData = [
  {
    id: "1",
    question: "Hello I <> rahul.",
    target: "am",
    distractors: ["is", "are", "you", "for"],
  },
  {
    id: "2",
  ...
  },
  {
    ...
    target: "is",
    distractors: ["am", "are", "you", "for"],
  },
  {
    id: "4",
    question: "  <> I know you.",
    target: "do",
    distractors: ["is", "does", "you", "for"],
  },
  {
    id: "5",
    question: " Hope  you <> doing well.",
    target: "are",
    distractors: ["is", "am", "you", "for"],
  },
];
...
function Spelling(props) {
  ...
  useEffect(() => {
    const loadActivity = () => {
      const { sentence } = SpellingUtils.initialize(mockData);
  ...
  const handleChange = (event, id) => {
    ...
    console.log("00000", cloneSentence);
    console.log("11111111", cloneSentence[index].trailCount);
